...
public class MysqlCreateBean implements BaseCreateBean {
    ...
    public void makeCode() {
      ...
      /*  //3.生成实体类
        ...
        //JOOQ CURD类
        CommParseUtil.ParseContent(0,DataMap,"MapperTemplateForJOOQ.ftl",DataMap.get("CP_Repository").toString());
        //5.生成Service层(service接口/实现类)
        CommParseUtil.ParseContent(0,DataMap,"ServiceTemplateForJOOQ.ftl",DataMap.get("CP_service").toString());
        CommParseUtil.ParseContent(0,DataMap,"ServiceImplTemplateForJOOQ.ftl",DataMap.get("CP_serviceimpl").toString());
    ...
    private void initDataMap(){
        ...
        DataMap.put("entityExtendName",CodeResourceUtil.ENTITY_EXTEND_NAME);
        ...
        DataMap.put("CP_beanJOOQ","entity\\" + CodeResourceUtil.PROJECT_NAME+"\\"+CodeResourceUtil.ENTITY_NAME+"Form.java");
